...
export async function POST(request) {
  try {
    ...
    const type = formData.get('type') || 'categories'; // 'articles', 'categories', etc.
    ...
    // Create directory based on type within our uploads directory
    ...
    // We'll serve these files through a different route
    const fileUrl = `${process.env.NEXT_PUBLIC_BASE_URL}/api/media/${type}/${uniqueFilename}`;
